(function() {
  ...
  function ghilardinfe(xml, cb) {
    parseString(xml, function (err, result) {
      ...
      cb(null, {
        cobranca: (NFe.cobr) ? new Cobranca(NFe.cobr[0] ? NFe.cobr[0] : null) : null,
        ...
        informacoesAd: (NFe.infAdic) ? new InformacoesAd(NFe.infAdic[0]) : null,
        ...
        chNFe: (infProt) ? new Protocolo(infProt[0].chNFe) : String(NFe['$']['Id']) ? String(NFe['$']['Id']) : null
      });
    });
  };

  module.exports = ghilardinfe;
