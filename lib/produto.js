(function() {
  ...
  Produto.prototype.getOutrasDesp = function() {
    return this.vOutro ? Number(this.vOutro) : 0;
  };

  Produto.prototype.getvDesc = function() {
    return this.vDesc ? Number(this.vDesc) : 0;
  };
